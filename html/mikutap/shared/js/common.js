...
aidn.util = {
    ...
    getCookie: function(e) {
        var t = null
          ...
          , i = document.cookie
          , e = i.indexOf(n);
        return 0 <= e && (-1 == (n = i.indexOf(";", e = e + n.length)) && (n = i.length),
        t = decodeURIComponent(i.substring(e, n))),
        t
    },
    ...
    needExpandArea: function(e) {
        ...
        return (t = (t = 0 <= n.indexOf("iPhone") || 0 <= n.indexOf("iPod")) && 0 <= n.indexOf("Version/") && Math.max(window.screen.width, window.screen.height) < 600) && 1 == e && (window.scrollTo(0, 0),
...
aidn.window = {
    ...
    _resize: function() {
        aidn.window._isTwitteriOS && aidn.window._isFit && aidn.util.getiOSVersion() < 14 && $("body").height(window.innerHeight + 20),
        aidn.window._isTwitteriOS ? (setTimeout(aidn.window._resizeFix, 100),
        setTimeout(aidn.window._resizeFix, 300)) : aidn.window._resizeFix()
    },
    _resizeFix: function() {
...
aidn.string = {
    ...
    insertBreakStr: function(e, t, n) {
        for (var i = this.calcStrWidth(e, t), n = Math.ceil(i / n), a = this.breakStr(t, n), o = 0; o < a.length; o++)
...
aidn.color = {
    hslToRgb: function(e) {
        ...
        e - e * o) : (i = e + (1 - e) * o,
        e - (1 - e) * o), o = a / 60, e = o <= 1 ? (n = a / 60 * ((t = i) - e) + e,
        ...
        return [Math.floor(255 * t), Math.floor(255 * n), Math.floor(255 * e)]
    },
    rgbToHsl: function(e) {
        var t = e[0]
          , n = e[1]
          ...
          , a = Math.max(t, n, i)
          , e = Math.min(t, n, i)
          , n = a == e ? 0 : t == a ? (n - i) / (a - e) * 60 : n == a ? (i - t) / (a - e) * 60 + 120 : (t - n) / (a - e) * 60 + 240;
        return n < 0 && (n += 360),
        [n, (a + e) / 2 < 127.5 ? a + e <= 0 ? 0 : (a - e) / (a + e) * 1 : (a - e) / (510 - a - e) * 1, (a + e) / 255 / 2 * 1]
    },
    hsvToRgb: function(e) {
...
function __addRelease(e, t, n, i, a, o, r, d) {
    ...
    "1" != aidn.util.getCookie(d))) {
        ...
        c && u || (v = '<link href="https://fonts.googleapis.com/css2?family=',
        c || (v += l),
        c || u || (v += "&family="),
        u || (v += s),
        ...
        var m = Date.now() + Math.floor(1e5 * Math.random())
          , v = "calc(0.6rem + 0.6vh)";
        24 <= n.length && (v = "calc(0.55rem + 0.5vh)");
        i = "bottom",
        i = "white-space: nowrap; position: fixed; " + (i = 1 == r ? "top" : i) + ": -2px; z-index: 100000; left: 50%; transform: translateX(-50%); width:100%; max-width: 480px; color: #fff; background:#555560d0; text-align:left; cursor:pointer; letter-spacing: .4rem; line-height: 1; border: solid 1px rgba(255, 255, 255, 0.2); transition: all .12s;",
        i = '<div id="rel_open' + m + '" style="' + (i += "font-family:Poppins,'Noto Sans JP',sans-serif;") + '">';
        i += '<img src="' + e + '" style="width:calc(45px + 2.4vh); height:calc(45px + 2.4vh); margin: calc(4px + 1.0vh); margin-right: calc(6px + 1.2vh); vertical-align:middle;">',
        i += '<p style="display:inline-block; vertical-align:middle; letter-spacing:.15rem; line-height:1.6; font-weight:500; margin-bottom:10px;">',
        i += '<span style="font-size:calc(0.4rem + 0.7vh); color: #f9a;" class="blink">' + a + "</span><br>",
        i += '<span style="font-size:' + v + '; border-bottom: calc(1px + 0.15vmin) solid; padding-bottom: 4px;">' + n + "</span>",
        i += "</p>",
        i += '<p id="rel_close' + m + '" style="position:absolute; right:0; top:0; padding:1vh;">',
        i += '<svg style="width: calc(24px + 2vmin); transition: fill .12s;" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path fill="#fff" d="M12 11.293l10.293-10.293.707.707-10.293 10.293 10.293 10.293-.707.707-10.293-10.293-10.293 10.293-.707-.707 10.293-10.293-10.293-10.293.707-.707 10.293 10.293z"/></svg>',
        i += "</p>",
        i += "</div>",
        $("body").append(i),
        i = "<style>\n.blink{\n",
        ...
        i += "#rel_open" + m + ":hover { background: #333339cc !important; } \n",
        i += "#rel_close" + m + ":hover > svg path { fill: #f9a !important; } \n",
        i += "</style>",
        $("head").append(i),
...
function __checkInit() {
    ...
    $(function() {
        ...
        var e = aidn.util.getiOSVersion();
        8 <= e && e < 14 && aidn.util.checkStandAlone() && (_ = "_start_url",
        localStorage.getItem(_) || localStorage.setItem(_, location.href),
        document.addEventListener("visibilitychange", function(e) {
            "visible" == document.visibilityState && location.href != localStorage.getItem(_) && (location.href = localStorage.getItem(_))
        }));
        for (var t = document.querySelectorAll(".lazy_css"), n = 0, o = t.length; n < o; n++)
            t[n].rel = "stylesheet";
        ...
        if ((0 < a.indexOf("MSIE") || 0 < a.indexOf("rv:11.0")) && 0 < $("svg").length && (i = -1,
        ...
        setTimeout(d, 300, e)),
        12.2 <= e) {
            for (var l, c = ["/mikuboard", "/vtofu", "/omikuji", "/momoko_vr", "/catsphere", "/shake", "/m/nijimi"], s = location.href, u = !1, o = 0, n = 0; n < c.length; n++)
                0 < s.indexOf(c[n]) && (u = !0,
                o = c[n].split("/").length - 2);
            1 != $("body").data("motion") || 2 <= (p = location.href.split("aidn")).length && (u = !0,
            o = p[1].split("/").length - 3),
            u && (l = setTimeout(function() {
                var e = "";
                e += '<div style="width:100%; height:100%; background:rgba(255, 255, 255, 0.975); position:fixed; z-index:1000000; top: 0; left: 0; display: none;">';
                var t = ""
        ...
        h(),
        setTimeout(h, 500)),
        0 < location.href.indexOf("/wow") && (f = `<p style="font-family: 'Sawarabi Gothic', sans-serif; font-size: calc(0.5rem + 0.6vmin); animation: none; margin-top: calc(15px + 1.5vmin);">[tx]</p>`,
        f = _isJapanese ? f.replace("[tx]", "サウンドをオンにしてお楽しみください。") : f.replace("[tx]", "Please enjoy this content with sound on."),
        $("#top").append(f));
        for (var f, p, g = !1, m = "NOW ON SALE", v = "NOW ON SALE", w = "nyancat10th/", y = "daniwell/shared/img/jacket/nyancat_arrangements.png", b = "Nyan Cat Arrangements", x = "Nyan Cat Arrangements", c = [{
            path: "/nyancat/"
        }, {
            path: "/momotap"
        }, {
            ...
            key: "_wow"
        }], s = location.href, u = !1, _ = "", n = 0; n < c.length; n++) {
            var k = c[n];
            if (0 < s.indexOf(k.path)) {
                u = !0,
                _ = "_sub",
                k.key && (_ = k.key),
                k.desc && (m = k.desc,
                ...
                k.descEn && (v = k.descEn),
                k.link && (w = k.link),
                k.imgPath && (y = k.imgPath),
                k.title && (b = k.title,
                x = k.title),
                k.titleEn && (x = k.titleEn),
                "boolean" == typeof k.topFlag && (g = k.topFlag);
                break
            }
        }
        if (0 < $("#aidnx").length || u) {
            var E = 2
            0 < $("#aidnx").length && (_ = "_aidnx");
            for (var O = "", n = 0; n < E - 1; n++)
                O += "../";
            y.indexOf("http") < 0 && (y = O + y),
            w.indexOf("http") < 0 && (w = O + w)
            // "" != O && __addRelease(y, w, b, x, m, v, g, _)
        }
        ...
        _active || (p = aidn.constant.advUrlEn,
        f = "",
        f += '<a href="' + (p = aidn.util.checkJapanese() ? aidn.constant.advUrlJa : p) + '" target="_blank"><div class="adv_con">',
        f += '<p class="text">' + aidn.constant.advTex + "</p>",
        f += '<p class="image"><img src="' + aidn.constant.advImg + '" alt="' + aidn.constant.advAlt + '" /></p>',
        f += "</div></a>",
        0 < (p = $("#common_back")).length && (f = '<div class="adv"><div class="hr_top"></div>' + f + "</div>",
...
aidn.WebAudio = function() {
    ...
    this.load = function(e, u, t, n) {
        ...
        h = null;
        var l, e = aidn.audio.getPath(e);
        return !(!e && !i) && (i ? c() : ((l = new XMLHttpRequest).open("GET", e, !0),
